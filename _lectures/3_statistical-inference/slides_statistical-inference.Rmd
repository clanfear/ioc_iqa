...
date: "29 Oct 2025<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%d %b %Y'))`"
output:
...
I also linked them to data on deprivation and subregions, which would take more work!<sup>1</sup>

.footnote[
[1] We'll actually make these in CRMW next term!
]
