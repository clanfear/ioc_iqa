...
* Multiply $x$ coefficient by 100 and it is the percent $y$ differs due to a difference in $x$
...
* No class next week if strike goes forward

## Last assignment

* Sent out by next Friday
