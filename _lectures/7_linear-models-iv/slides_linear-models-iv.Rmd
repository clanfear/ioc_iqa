...
```{r}
metro_2021_crime    <- read_csv("./_data/metro_2021_crime.csv")
borough_deprivation <- read_csv("./_data/borough_deprivation.csv")
borough_pop_density <- read_csv("./_data/borough_pop_density.csv")
london_subregion    <- read_csv("./_data/london_subregion.csv")
```
