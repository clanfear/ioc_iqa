...
> Given the DAG above, run a **linear model** that identifies the total effect of `sex` on `sentence`. Present the output here and interpret the coefficient on sex including its statistical significance.
